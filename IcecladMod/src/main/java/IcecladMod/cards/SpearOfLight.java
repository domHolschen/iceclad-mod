...
public class SpearOfLight extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(SpearOfLight.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("PlaceholderSpear2.png");
