...
import IcecladMod.actions.HighVelocityAction;
...
public class HighVelocity extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(HighVelocity.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new HighVelocityAction());
    }
