...
public class Smash extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(Smash.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (m.hasPower(IciclePower.POWER_ID)) {
            int icicleAmount = m.getPower(IciclePower.POWER_ID).amount;
            AbstractDungeon.actionManager.addToBottom(new RemoveSpecificPowerAction(m, p, IciclePower.POWER_ID));
            AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, icicleAmount, DamageInfo.DamageType.THORNS)));
        }
    }
