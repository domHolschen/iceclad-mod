...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = IcecladMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = IcecladMod.makeID("BasicStrikeCard"); // DELETE THIS ONE.
