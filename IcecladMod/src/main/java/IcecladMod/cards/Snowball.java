...
import IcecladMod.patches.AbstractCardField;
...
public class Snowball extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(Snowball.class.getSimpleName());
    ...
    private static final int UPGRADE_PLUS_DMG_INC = 1;
    ...
    public Snowball() {
        ...
        CardModifierManager.addModifier(this, new RetreatCardModifier());
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            ...
            upgradeMagicNumber(UPGRADE_PLUS_DMG_INC);
