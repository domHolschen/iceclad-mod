...
import IcecladMod.actions.GainBriskOnKillAction;
...
public class FloorIt extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(FloorIt.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom((AbstractGameAction)new VFXAction((AbstractGameEffect)new BiteEffect(m.hb.cX, m.hb.cY - 40.0F * Settings.scale, Color.GREEN.cpy()), 0.5F));
        AbstractDungeon.actionManager.addToBottom( // The action managed queues all the actions a card should do.
                new GainBriskOnKillAction(m, new DamageInfo(p, damage, damageTypeForTurn)));
    }
