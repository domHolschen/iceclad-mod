...
import IcecladMod.powers.IceCubeNextTurn;
...
public class Deploy extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(Deploy.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("DeployPlaceholder.png");
    ...
    private static final int ICE_CUBES_THIS_TURN = 1;
    private static final int ICE_CUBES_NEXT_TURN = 2;
    private static final int ICE_CUBES_NEXT_TURN_UPGRADE = 1;
    ...
    public Deploy() {
        ...
        this.exhaust = true;
        this.baseMagicNumber = ICE_CUBES_NEXT_TURN;
        magicNumber = baseMagicNumber;
        this.cardsToPreview = new IceCube();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInHandAction(cardsToPreview, ICE_CUBES_THIS_TURN));
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new IceCubeNextTurn(p, p, magicNumber)));
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(ICE_CUBES_NEXT_TURN_UPGRADE);
