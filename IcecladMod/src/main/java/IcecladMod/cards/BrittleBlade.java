...
public class BrittleBlade extends CustomCard {
    ...
    public static final String ID = IcecladMod.makeID(BrittleBlade.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInHandAction(cardsToPreview));
    }
